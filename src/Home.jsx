...
import {URL_SHORTENER_API_ENDPOINT,BASE_URL} from './config'
...
export default function Home() {
  ...
  function formatShortUrl(shortUrlKey) {
    return BASE_URL +'s/'+ shortUrlKey;
  }

  function copyUrlToClipboard() {
    navigator.clipboard.writeText(formatShortUrl(shortUrl));
    const textElement = document.querySelector("#copied");
  ...
  async function handleSubmit(event) {
    ...
    try {
      const response = await fetch(URL_SHORTENER_API_ENDPOINT, {
        method: "POST",
      ...
      <div className="max-w-2xl mx-auto min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <div className=" w-full mt-6 flex rounded-md shadow-sm">
          <div className="relative flex-grow focus-within:z-10">
            ...
            <input
              className="text-gray-700 py-3 form-input block w-full rounded-none rounded-l-md pl-10 transition ease-in-out duration-150 font-semibold sm:text-sm sm:leading-5"
          ...
          {!isLoading ? (
            ...
            >
              ...
              <span className="ml-2 text-sm font-semibold">Shorten</span>
            </button>
          ) : (
            <button className="group -ml-px relative inline-flex items-center px-3 py-3 border border-indigo-300 text-sm leading-5 font-medium rounded-r-md text-white bg-indigo-700 hover:text-indigo-700 hover:bg-white focus:outline-none focus:shadow-outline-blue focus:border-indigo-300 active:bg-gray-100 active:text-indigo-700 transition ease-in-out duration-150">
              <svg
                className="text-white h-5 w-5 group-hover:text-indigo-700 animate-spin"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              ...
              <span className="ml-2 text-sm font-semibold">Shortening</span>
            </button>
          )}
        </div>
        ...
        {shortUrl ? (
          <div className="py-6 w-full">
            <div
              className="my-3 bg-white shadow rounded-lg"
            ...
            >
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="mt-3 text-sm leading-5 flex">
                  <a
                    href={formatShortUrl(shortUrl)}
                    target="_blank"
                  ...
                  <button className="mx-2" onClick={copyUrlToClipboard}>
                    <svg
                      className="gray-500"
                      height="20px"
                      width="20px"
		...
		z"
                  ...
                  <span
                    className="text-gray-500 opacity-0 transition duration-500"
                    id="copied"
                  >
                    copied!
                  </span>
